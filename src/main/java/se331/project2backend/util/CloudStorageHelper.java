...
//        try{
//            serviceAccount = new ClassPathResource("imageupload-fc24d-85987d2dd263.json").getInputStream();
//            storage = StorageOptions.newBuilder().setCredentials(GoogleCredentials.fromStream(serviceAccount)).setProjectId("imageupload-fc24d").build().getService();
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//    }
